...
$(document).ready(function(){
   ...
   .buttons([
    ...
    },
    {
     ...
     click:function(e)
     {
	  ...
	  form_data.append('report_content', $('#report_content').val());
      $.ajax({
       method:"POST",
       url:'insert_data.php',
       data:form_data,
 ...
 $(document).on('click', '.update', function(){
  ...
  $.ajax({
   ...
   success:function(data)
   {
    localStorage.setItem('report_title', data[0].report_title);
	localStorage.setItem('report_date', data[0].report_date);
	localStorage.setItem('report_content', data[0].report_content);	
