...
<html lang="en"> <!-- Set page language to english -->
  ...
  <!-- Links to different pages -->
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="registernow.php">Fixtures and Results</a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="registernow.php">league Table</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="registernow.php">Team</a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="registernow.php">Match Reports</a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="registernow.php">Events</a>
      </li>
      <li class="nav-item">
	...
	<!-- Brand image on the right side of the nav bar -->
